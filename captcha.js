...
let cargo = message.guild.roles.cache.get("teu ")
...
message.channel.send(capt).then(msg => {
  ...
  .on("collect", message => {
    ...
    if(arg !== content) {
      ...
      let canal = client.channels.cache.get("847210828197527628")
const embed = new MessageEmbed()
    .setTitle('Captcha')
    .setDescription(`Parabéns ${message.author} você foi verificado(a)!`)
